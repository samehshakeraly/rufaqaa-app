...
/**
 * Shared stroke-icon set for the partner-manager portal (PM-01..PM-04).
 * Sized via the `.pm-icon` / `.pm-icon-sm` utilities defined in
 * PartnerLayout.css. Ported 1:1 from the partner-mgr mockups.
 */
export function Icon({
  children,
  className = "pm-icon pm-icon-sm",
}: {
  children: ReactNode;
  className?: string;
}) {
