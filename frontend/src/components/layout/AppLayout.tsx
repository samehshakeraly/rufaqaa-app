...
const TITLE_MAP: ReadonlyArray<readonly [string, string]> = [
  ...
  ["/admin/reports/community", "nav.communityFollowup"],
        ...
        <nav className="oa-nav" aria-label={t("nav.primary")}>
          ...
          {isFullContentManager && (
            <>
              ...
              <NavLink to="/admin/reports" end className={navItemClass}>
              ...
              <NavLink to="/admin/reports/community" className={navItemClass}>
                <NavIco>{ICONS.users}</NavIco>
                {t("nav.communityFollowup")}
              </NavLink>
